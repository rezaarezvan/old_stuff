...
public class ControlHandler {
    ...
    public ControlHandler(Frame frame) {
        ...
        // Lägger till alla JLabels i en lista
        labels.add(modeText);
        labels.add(speedT);
        labels.add(speedC);
        labels.add(openT);
        ...
        // Lägger till checkboxarna i en lista
        ...
        // JButtons till en lista
        buttons.add(run);
    }
    
    // Får en specifik JLabel med namnet
    ...
    // Får en specifik JCheckBox med namnet
    ...
    // Får en specifik JButton med namnet
    ...
    // Lägger till allting till framen
    public void addAll() {
