...
import java.util.*;
public class Kö_test_2{  //Prioritetskö  
    ...
    public static void skrivUt(PriorityQueue<String> personer){
        if(personer.isEmpty()){
            System.out.println("\nKön är tom.");
        }
        else{
    ...
    public static void laggTill(PriorityQueue<String> personer){
        String s = Kbd.readString("\nNy person: ");
        personer.offer(s);
    }

    public static void exped(PriorityQueue<String> personer){
        if(personer.isEmpty()){
            System.out.println("\nKön är tom.");
        }
        else{
